...
import 'package:flutterotp/auth_service.dart';
import 'package:flutterotp/pages/hme_page.dart';
      ...
      AuthService.loginWithOtp(otp: _otpContoller.text).then((value) {
        if (value == "Success") {
          ...
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (context) => homepage(camera:camera)));
        } else {
          Navigator.pop(context);
